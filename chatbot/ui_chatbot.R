ui <- fluidPage(
  ...
  tags$head(
    ...
    tags$style(HTML("
      ...
      .file-list-container th, .file-list-container td {
        border: 1px solid #DDDDDD;
        padding: 10px;
        text-align: left;
      }
  ...
  navbarPage(
    title = div(
      img(src = "~/work/budgibot/chatbot/logo.png", height = "30px", style = "margin-right: 10px;"),
      "BudgiBot"
    ),
    id = "navbar",
      ...
      div(class = "container-fluid",
          div(class = "row",
              div(class = "col-md-8 offset-md-2",
                  ...
                  # Typing indicator below chat history
                  div(class = "typing-indicator-wrapper",
                      uiOutput("typing_indicator")
                  ),
                  
                  # Input box
                  div(class = "input-container",
                      textAreaInput("user_input", label = NULL,
                                    placeholder = "Posez votre question ici...", rows = 3
                      )
                  ),
                  ...
                  # Drop Zone
                  div(id = "drop_zone",
                      "Déposez votre fichier ici (PDF, DOCX, TXT, MSG)"
                  ),
                  
                  # File upload button
                  div(class = "file-input-container",
                      tags$label("Joindre un fichier", class = "btn btn-primary",
                                 tags$input(id = "file_input", type = "file",
                                            style = "display: none;",
                  ...
                  # Button to show extracted data modal
